...
class Teacher(Person):
    def __init__(self, name, surname, gender,university:University, faculty:str, experience:int, start_work_at:Date, subject:str, salary:int):
        ...
        if type(salary) is not int:
            ...
            self._salary = salary
    def __repr__(self):
        return "{} {} {} {} {} {} {} {}".format(self._name, self._surname, self._gender, self._university,
self._founded_at, self._faculty,self._experience, self._start_work_at, self._surname, self._salary)
...
class Student(Person):
    ...
    def __repr__(self):
        return "{} {} {} {} {} {} {}".format(self._name, self._surname, self._gender, self._university,
self._faculty, self._course, self._start_work_at)
    @property
